...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initializeCardHoverEffects() {
    projectCards.forEach((card) => {
      ...
      card.addEventListener("mouseenter", function () {
        ...
        this.style.boxShadow = "0 30px 60px -12px rgba(37, 99, 235, 0.25)";
  ...
  const ctaButton = document.querySelector(".bg-white.text-blue-600");
  if (ctaButton) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const solutionsData = {
    assessment: {
      ...
      description:
        "نوفر ونركب أحدث المعدات والأنظمة من أفضل الماركات العالمية، مع ضمان الجودة والكفاءة في التركيب والتشغيل.",
    },
    design: {
      ...
      description:
        "نقدم خدمات التصميم والهندسة المتطورة باستخدام أحدث التقنيات والبرامج المتخصصة، مع ضمان التوافق الكامل مع جميع المعايير المحلية والدولية للسلامة.",
    },
    supply: {
      ...
      description:
        "التقييم الدقيق هو الأساس لأي نظام حماية فعال. نحن نحلل كل جانب من جوانب منشأتك لنضع خطة حماية مخصصة تناسب احتياجاتك الفريدة وتضمن أعلى مستويات الأمان.",
    },
    testing: {
      ...
      description:
        "نجري اختبارات شاملة ودقيقة لجميع الأنظمة والمعدات لضمان عملها بأعلى كفاءة وجاهزيتها الكاملة للتعامل مع أي حالة طوارئ.",
    },
    maintenance: {
      ...
      description:
        "نقدم خدمات الصيانة والدعم الفني المتكاملة مع عقود مرنة تضمن استمرارية عمل أنظمتك بأعلى كفاءة وجاهزية دائمة.",
    },
    training: {
      ...
      description:
        "نقدم برامج تدريبية شاملة ومتخصصة لضمان جاهزية فرق العمل والموظفين للتعامل مع حالات الطوارئ بكفاءة وفعالية.",
    },
  };
  ...
  <div class="solution-content active" id="${solutionType}-content">
    <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
      ...
      <div class="p-8">
        <div class="grid md:grid-cols-2 gap-6 mb-8">
          <div class="space-y-4">
            <h4 class="text-xl font-bold text-dark-gray mb-4">
              <i class="fas fa-clipboard-check text-blue-500 ml-2"></i>
              ما نقدمه:
            </h4>
            <div class="space-y-3">
              ${solution.services
            ...
            <div class="space-y-3">
              ${solution.features
                .map(
                  (feature) => `
                  <div class="flex items-center">
                    <i class="fas fa-medal text-blue-500 ml-2"></i>
                    <span>${feature}</span>
                  </div>
                `
                )
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-400 p-6 rounded-xl text-white">
...
`;
  ...
  function animateContentElements() {
    const elements = document.querySelectorAll(
      "#content-area .flex, #content-area .bg-gradient-to-r"
    );
...
.animated-border:hover::before {
  ...
  console.log(
    "🔥 Integrated Solutions Section - JavaScript Loaded Successfully!"
  );
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function initializeCarousel() {
    ...
    document
      .querySelectorAll(
        ".animate-fade-in, .animate-slide-in-right, .animate-slide-in-left, .animate-slide-in-up"
      )
      .forEach((el) => {
        observer.observe(el);
      });
...
.nav-dot:hover {
    transform: scale(1.1);
    background: rgba(59, 130, 246, 0.5); /* ازرق شفاف */
}

.nav-dot.active {
    background: linear-gradient(135deg, #3B82F6, #60A5FA); /* تدرج أزرق */
    transform: scale(1.2);
}
...
.btn-primary:hover {
    transform: translateY(-2px);
    box-shadow: 0 10px 25px rgba(59, 130, 246, 0.3); /* ظل ازرق */
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function animateTabContent(tabContent) {
    const elements = tabContent.querySelectorAll(
      ".feature-item, .btn-primary, h3, p, .text-xl"
    );
...
document.querySelectorAll(".feature-card").forEach((card, index) => {
  card.addEventListener("mouseenter", () => {
    ...
    ripple.style.background =
      "radial-gradient(circle, rgba(91, 52, 244, 0.3) 0%, transparent 70%)";
    ripple.style.borderRadius = "50%";
...
document
  .querySelectorAll(".text-blue-600, .text-blue-600")
  .forEach((element) => {
